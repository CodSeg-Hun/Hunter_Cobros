Public Class Clsreciboprueba


    Public Shared Function DatosGeneral2(ByVal cliente As String, ByVal opcion As Integer, ByVal usuario As String) As DataSet
    ...
    Public Function CargaForma2() As DataTable
        CargaForma2 = Nothing
    ...
    Public Function CargaCartera2() As DataTable
        CargaCartera2 = Nothing
        Dim dt As New DataTable
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Function CargaPlazo2() As DataTable
        CargaPlazo2 = Nothing
        Dim dt As New DataTable
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Function CargaRetencionIva2() As DataTable
        CargaRetencionIva2 = Nothing
        Dim dt As New DataTable
        Dim base As New DataBaseApp.CommandApp
        Try
            base.AddParrameter("@OPCION", 23)
            dt.Load(base.ConsultaReader("Extranet.SP_WEB_HUNTERRECIBO"))
            CargaRetencionIva2 = dt
        Catch ex As Exception
            Throw
        Finally
            If base.Connection.State = ConnectionState.Open Then base.Connection.Close()
    ...
    Public Function CargaRetencionFuente2() As DataTable
        CargaRetencionFuente2 = Nothing
        Dim dt As New DataTable
        Dim base As New DataBaseApp.CommandApp
        Try
            base.AddParrameter("@OPCION", 22)
            dt.Load(base.ConsultaReader("Extranet.SP_WEB_HUNTERRECIBO"))
            CargaRetencionFuente2 = dt
        Catch ex As Exception
            Throw
        Finally
            If base.Connection.State = ConnectionState.Open Then base.Connection.Close()
    ...
    Public Shared Function VerificaTarjeta2(ByVal tarjeta As String) As DataSet
        Dim ds As New DataSet
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Function CargaBanco2() As DataTable
        CargaBanco2 = Nothing
        Dim dt As New DataTable
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Function CargaReferencia2() As DataTable
        CargaReferencia2 = Nothing
        Dim dt As New DataTable
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Function CargaTarjeta2() As DataTable
        CargaTarjeta2 = Nothing
        Dim dt As New DataTable
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Shared Function ConsultaRuta2() As DataSet
        Dim ds As New DataSet
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Shared Function LeerEmail2(ByVal cliente As String, ByVal documentoId As String, ByVal tipo As String, ByVal usuario As String) As DataSet
        Dim ds As New DataSet
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Shared Function DatosGeneralPdf2(ByVal cliente As String, ByVal anticipo As String) As DataSet
        Dim ds As New DataSet
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Shared Function ProcesoConsultar2(ByVal opcion As Integer, ByVal fechainicio As String, ByVal fechafin As String, ByVal usuarioId As String, ByVal estadoId As String, ByVal usuario As String) As DataSet
        Dim ds As New DataSet
        Dim base As New DataBaseApp.CommandApp
        Try
            base.AddParrameter("@OPCION", opcion)
    ...
    Function ConsultaInformacionDetalle2(ByVal numero As String, ByVal tipo As String) As DataTable
        ConsultaInformacionDetalle2 = New DataTable
        Dim datos As New DataBaseApp.CommandApp
        Try
            datos.AddParrameter("@OPCION", 11)
            datos.AddParrameter("@NUMERO_ANTICIPO", numero)
            datos.AddParrameter("@TIPO_INGRESO", tipo)
            ConsultaInformacionDetalle2.Load(datos.ConsultaReader("Extranet.SP_WEB_HUNTERRECIBO"))
        Catch ex As Exception
            Throw ex
        Finally
    ...
    Public Shared Function GrabaEstado2(ByVal usuarioId As String, ByVal estadoId As String, ByVal numero As String, ByVal observacion As String, ByVal motivo As Int32)
        Dim ds As New DataSet
        Dim base As New DataBaseApp.CommandApp
        Try
    ...
    Public Shared Sub RegistroLog2(ByVal opcion As String, ByVal mensaje As String, ByVal usuarioid As String)
        Dim base As New DataBaseApp.CommandApp
    ...
    Public Function RegistraInformacion2(ByVal clienteId As String, ByVal email As String, ByVal recibeId As String, ByVal recibeNombre As String,
                                        ByVal usuarioId As String, ByVal valor As Double, ByVal detalle As dsHunterCobro.ANTICIPO_DETALLEDataTable, ByVal comentario As String,
                                        ByVal tipo As String, ByVal cliente As String, ByVal referencia As dsHunterCobro.REFERENCIA_DETALLEDataTable, ByVal tipoServicio As String,
    ...
    Public Function RegistraInformacion(ByVal clienteId As String, ByVal email As String, ByVal recibeId As String, ByVal recibeNombre As String,
                                        ByVal usuarioId As String, ByVal valor As Double, ByVal detalle As dsHunterCobro.ANTICIPO_DETALLEDataTable, ByVal comentario As String,
                                        ByVal tipo As String, ByVal cliente As String, ByVal referencia As dsHunterCobro.REFERENCIA_DETALLEDataTable, ByVal tipoServicio As String,
                                        ByVal usuariocartera As String)
        Dim base As New DataBaseApp.CommandApp
