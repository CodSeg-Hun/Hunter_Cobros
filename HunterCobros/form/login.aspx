...
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <div id="inhalt">
                    <div class="login_sec_001">
                        ...
                        <div class="login_sec_002">
                            ...
                            <asp:ImageButton ID="BtnLogin" runat="server"  EnableDefaultAppearance="False" EnableTheming="False"
                                    EnableViewState="False"  Height="38" Width="93" TabIndex="3" ImageUrl="../imagen/login_button_001.png" 
                                 OnMouseOver="this.src='../imagen/login_button_002.png'"
    OnMouseOut="this.src='../imagen/login_button_001.png'"
    OnMouseDown="this.src='../imagen/login_button_003.png'"
    OnMouseUp="this.src='../imagen/login_button_002.png'"
    OnClick="BtnLogin_Click"></asp:ImageButton>
                        ...
                        <div class="region04">
                            &copy; Carseg S.A. 2025. Todos los derechos reservados &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                    </div>
                </div>
            </div>
